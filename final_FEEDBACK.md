...
- You may need to ask users to play a game before you output each player's loss. And then count based on the next play. It's only when players no longer want to play that you have to display players losses. 
- The game never stops. I added the logic to make it stop 
### Grade: M
