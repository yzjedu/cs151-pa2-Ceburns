...
#this sets the guidlines for the game
...
#this loops the code until there are no more sticks left
SENTINEL = 0
...
#this allows users to decide if they would like to play again or not
